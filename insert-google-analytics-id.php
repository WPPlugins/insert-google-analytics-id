...
<li>You can verify the integration by using "Tag Assistant" extension in Google chrome. Otherwise you may directly logon to google analytics account and go to Reporting --> Real-TIme --> Overview section and check for online users. Please keep your website open in another window.<br><br>
